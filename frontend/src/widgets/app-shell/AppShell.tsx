...
import PmRecordListPage from '../../modules/pm-record/pages/PmRecordListPage'
import PmRecordFormPage from '../../modules/pm-record/pages/PmRecordFormPage'
import WorkOrderPlanFormPage from '../../modules/work-order/pages/WorkOrderPlanFormPage'
import WorkOrderResultFormPage from '../../modules/work-order/pages/WorkOrderResultFormPage'
import WorkOrderListPage from '../../modules/work-order/pages/WorkOrderListPage'
import EquipmentListPage from '../../modules/equipment/pages/EquipmentListPage'
import WorkPermitListPage from '../../modules/work-permit/pages/WorkPermitListPage'
...
import PurchaseOrderPage from '../../modules/purchase-order/pages/PurchaseOrderPage'
import InventoryTransactionPage from '../../modules/inventory/pages/InventoryTransactionPage'
import InventoryLedgerPage from '../../modules/inventory/pages/InventoryLedgerPage'
...
import ApprovalFormPage from '../../modules/approval/pages/ApprovalFormPage'
import ApprovalDetailPage from '../../modules/approval/pages/ApprovalDetailPage'
import FreeBoardPage from '../../modules/board/pages/FreeBoardPage'
