import { APPROVAL_MODULE_LABELS as moduleLabels, APPROVAL_STATUS_LABELS as statusLabels } from '../../entities/approval/constants'
import { useEffect, useState } from 'react'
import type { LoginInfo } from '../../entities/auth/types'
import type { ApprovalFolder, ApprovalResponse } from '../../entities/approval/types'
