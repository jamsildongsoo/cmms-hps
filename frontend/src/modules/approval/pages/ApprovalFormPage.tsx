import { APPROVAL_PARTICIPANT_TYPE_LABELS, APPROVAL_PARTICIPANT_OPTIONS } from '../types/constants'
import { useEffect, useState } from 'react'
import type { LoginInfo } from '../../auth/types/types'
import type { ApprovalParticipant, ApprovalParticipantType, ApprovalResponse } from '../types/types'
import { createApprovalDraft, saveApprovalDraft, submitApproval } from '../api/approvalApi'
import { getOrganization } from '../../org/api/orgApi'
