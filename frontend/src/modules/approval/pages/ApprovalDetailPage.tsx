import { APPROVAL_MODULE_LABELS as moduleLabels, APPROVAL_STATUS_LABELS as statusLabels, APPROVAL_PARTICIPANT_TYPE_LABELS as participantLabels } from '../types/constants'
import { useEffect, useState } from 'react'
import type { LoginInfo } from '../../auth/types/types'
import type { ApprovalResponse } from '../types/types'
import { getApproval, processApproval } from '../api/approvalApi'
