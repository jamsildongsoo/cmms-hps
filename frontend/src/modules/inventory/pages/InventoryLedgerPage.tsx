...
import type { InventoryLedgerEntry } from '../types/types'
import { getInventoryLedger } from '../api/inventoryApi'
...
export default function InventoryLedgerPage() {
  ...
  return (
    <main className="page page-screen">
      ...
      <section className="card filter-card"><div className="form-grid form-grid--4"><label className="field field--span-3">검색어<input value={keyword} onChange={(event) => setKeyword(event.target.value)} placeholder="자재번호·창고번호·연계번호" /></label></div></section>
