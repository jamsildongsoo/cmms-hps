import type { PurchaseOrderCreateRequest, PurchaseOrderResponse } from '../types/types'
import type { PurchaseRequestCreateRequest, PurchaseRequestResponse } from '../../purchase-request/types/types'
